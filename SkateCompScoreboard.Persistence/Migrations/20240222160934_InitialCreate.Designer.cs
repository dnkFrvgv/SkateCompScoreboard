...
namespace SkateCompScoreboard.Persistence.Migrations
{
    ...
    [Migration("20240222160934_InitialCreate")]
            ...
            modelBuilder.Entity("SkateCompScoreboard.Core.Entities.Score", b =>
                {
                    ...
                    b.Property<Guid?>("CompetitorId1")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("CompetitorRoundId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompetitorRoundId", "CompetitorId1");
            ...
            modelBuilder.Entity("SkateCompScoreboard.Core.Entities.Score", b =>
                {
                    ...
                    b.HasOne("SkateCompScoreboard.Core.Entities.RoundCompetitor", "Competitor")
                        .WithMany("Scores")
                        .HasForeignKey("CompetitorRoundId", "CompetitorId1");
